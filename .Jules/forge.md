...
## 2026-06-09 - [Task Pinning Implementation] **Learning:** Settings table acts as an excellent, safe, schema-migration-free persistent store for lightweight application features like saved comma-separated UI states (pinned items, hidden categories). **Action:** Always consider using the  key-value table before committing to complex SQLite schema redesigns for small features.
## 2026-06-09 - [Task Pinning Implementation] **Learning:** Settings table acts as an excellent, safe, schema-migration-free persistent store for lightweight application features like saved comma-separated UI states (pinned items, hidden categories). **Action:** Always consider using the settings key-value table before committing to complex SQLite schema redesigns for small features.
